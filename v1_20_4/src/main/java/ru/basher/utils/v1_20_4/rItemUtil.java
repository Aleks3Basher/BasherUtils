...
public class rItemUtil implements IItemUtil {
    ...
    public @NotNull String serializeItemStack(@NotNull ItemStack itemStack) {
        ...
        net.minecraft.nbt.NBTTagCompound nmsTagCompound = nmsItemStack.b(new  net.minecraft.nbt.NBTTagCompound());
        return new String(Base64.getEncoder().encode(nmsTagCompound.toString().getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
    }
    ...
    public @NotNull ItemStack deserializeItemStack(@NotNull String serializedItemStack) throws Exception {
        ...
        net.minecraft.nbt.NBTTagCompound nmsTagComp = net.minecraft.nbt.MojangsonParser.a(decoded);
        net.minecraft.world.item.ItemStack nmsItemStack = net.minecraft.world.item.ItemStack.a(nmsTagComp);
