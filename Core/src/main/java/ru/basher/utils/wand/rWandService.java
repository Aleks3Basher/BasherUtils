...
import ru.basher.utils.Service;
import ru.basher.utils.location.V3;
import ru.basher.utils.wand.listener.WandListener;

import java.util.HashMap;
import java.util.Map;
import java.util.UUID;

public class rWandService implements Service {
	...
	public rWandService(Plugin plugin) {
		this.plugin = plugin;
